...
import type{ LoginSuccessResType } from '@/utils/wsType'
...
export default {
  sendCode: (params?: any) => postRequest<{ msg: string }>(urls.sendCode, params),

  register: (params?: any) => postRequest<LoginSuccessResType>(urls.register, params),

  login: (params?: any) => postRequest<LoginSuccessResType>(urls.login, params),
  /** 获取群成员列表 */
